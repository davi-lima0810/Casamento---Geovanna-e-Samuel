export default function EventInfo() {
  ...
  return (
    <section className="relative mt-12 overflow-hidden rounded-[35px] border border-rose-100 bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,.08)]">
      ...
      <div className="relative z-10">
        ...
        <div className="mt-10 grid gap-6">
          ...
          {infos.map((info) => (
            <div
              key={info.titulo}
              className="group rounded-3xl border border-rose-100 bg-gradient-to-r from-white via-rose-50 to-pink-50 p-6 transition duration-300 hover:-translate-y-1 hover:shadow-2xl"
            >
              <div className="flex items-center gap-5">

                <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-rose-500 to-pink-500 text-4xl text-white shadow-xl transition duration-300 group-hover:scale-110">
                  {info.icone}
                </div>

                <div className="flex-1">

                  <p className="text-xs font-semibold uppercase tracking-[4px] text-rose-400">
                    {info.titulo}
                  </p>
        ...
        {/* Destaque */}
        <div className="mt-10 rounded-3xl bg-gradient-to-r from-rose-500 to-pink-500 p-7 text-center text-white shadow-xl">
